...
public class FoodDonationEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FoodDonation donation = (FoodDonation) getIntent().getSerializableExtra("passedFoodDonation");
        ...
        ChildEventListener childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                FirebaseDatabase.getInstance().getReference().child("Donations").child("Food")
                    ...
                    Intent intent = new Intent(FoodDonationEditActivity.this, FoodDonationViewActivity.class);
                    intent.putExtra("selectedFoodDonation", (Serializable) newDonation);
